...
<body>
  <div class="dashboard">
    ...
    <div class="main-content">
      ...
      <div class="table-container" id="pending-employers">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button
                  ...
                  onclick="viewDocuments('tech-solutions')">
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openEmployerModal('tech-solutions')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button
                  class="action-btn approve-btn"
                  onclick="approveEmployer('tech-solutions')">
                  <i class="fas fa-check"></i> Approve
                </button>
                <button
                  class="action-btn reject-btn"
                  onclick="rejectEmployer('tech-solutions')">
            ...
            <tr>
              <td>
                <div style="display: flex; align-items: center; gap: 0.75rem">
                  <img
                    src="https://ui-avatars.com/api/?name=Green+Energy&background=10b981&color=fff"
                    width="32"
                    height="32"
                    style="border-radius: 50%" />
                  Green Energy Ltd.
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="viewDocuments('green-energy')">
                  <i class="fas fa-file-alt"></i> View Docs
                </button>
              </td>
              <td>2023-10-14</td>
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openEmployerModal('green-energy')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button
                  class="action-btn approve-btn"
                  onclick="approveEmployer('green-energy')">
                  <i class="fas fa-check"></i> Approve
                </button>
                <button
                  class="action-btn reject-btn"
                  onclick="rejectEmployer('green-energy')">
                  <i class="fas fa-times"></i> Reject
                </button>
              </td>
            </tr>
      ...
      <!-- Posted Jobs Table -->
      <div class="table-container" id="posted-jobs">
        <div class="table-header">
          <h2>Posted Jobs</h2>
          <div class="table-actions">
            <input
            ...
            <select class="filter-dropdown">
              ...
              <option>Green Energy Ltd.</option>
              <option>Digital Creations</option>
            </select>
          </div>
        </div>
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openJobModal('frontend-dev')">
                  <i class="fas fa-eye"></i> View
                </button>
            ...
            <tr>
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openJobModal('marketing-manager')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button class="action-btn reject-btn">
                  <i class="fas fa-ban"></i> Deactivate
            ...
            <tr>
              ...
              <td>
                <div style="display: flex; align-items: center; gap: 0.75rem">
                  <img
                    src="https://ui-avatars.com/api/?name=Digital+Creations&background=8b5cf6&color=fff"
                    width="24"
                    height="24"
                    style="border-radius: 50%" />
                  Digital Creations
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openJobModal('backend-engineer')">
                  <i class="fas fa-eye"></i> View
                </button>
            ...
            <tr>
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openJobModal('ui-ux-designer')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button class="action-btn reject-btn">
                  <i class="fas fa-ban"></i> Deactivate
      ...
      <div class="table-container" id="verified-employers">
        <div class="table-header">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openEmployerModal('digital-creations')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button
                  class="action-btn reject-btn"
                  onclick="revokeVerification('digital-creations')">
            ...
            <tr>
              <td>
                <div style="display: flex; align-items: center; gap: 0.75rem">
                  <img
                    src="https://ui-avatars.com/api/?name=Urban+Foods&background=f59e0b&color=fff"
                    width="32"
                    height="32"
                    style="border-radius: 50%" />
                  Urban Foods
              ...
              <td>
                <button
                  class="action-btn view-btn"
                  onclick="openEmployerModal('urban-foods')">
                  <i class="fas fa-eye"></i> View
                </button>
                <button
                  class="action-btn reject-btn"
                  onclick="revokeVerification('urban-foods')">
                  <i class="fas fa-user-slash"></i> Revoke
                </button>
              </td>
            </tr>
      ...
      <!-- Applicants Table -->
      <div class="table-container" id="applicants">
        <div class="table-header">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>2023-10-15</td>
              <td>
                <span class="status verified"><i class="fas fa-circle"></i> Referred</span>
              </td>
              <td>
                <button
                  class="action-btn view-btn"
      ...
      <div class="profile-section">
        ...
        <div class="profile-info">
          ...
          <p>
            Applied for:
            <strong>
              <td>Frontend Developer at Tech Solutions Inc.</td>
            </strong>
          </p>
          <p>Applied on: <strong>October 16, 2023</strong></p>
          <p>
            Status:
            <span class="status pending"><i class="fas fa-circle"></i> Pending Review</span>
          </p>
            ...
            <div class="detail-row">
              ...
              <span><a
                  ...
                  style="
                      ...
                      font-weight: 500;
                    "><i class="fas fa-download"></i> Download PDF</a></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="profile-section">
        ...
        <div class="profile-info">
          ...
          <p id="jobCompany">
            <strong>Tech Solutions Inc.</strong> • New York, NY
          </p>
          <p id="jobSalary"><strong>$85,000</strong> • Full-time</p>
          <p id="jobDates">
            Posted: <strong>2023-10-10</strong> • Expires:
            <strong>2023-11-10</strong>
          </p>
          ...
          <div class="job-details">
            ...
            <div class="job-description">
              <p>
                ...
                team. You will be responsible for building user interfaces and
                implementing interactive web applications using modern
              ...
              <ul style="padding-left: 1.5rem; margin-top: 0.5rem">
                ...
                <li>Experience with state management (Redux)</li>
      ...
      <div class="details-section" style="margin-top: 1.5rem">
        <h4 style="margin-bottom: 1rem">Applications Summary</h4>
        <div
          style="
              display: grid;
      ...
      <div class="buttons-container">
        ...
        <button class="btn btn-danger">
          <i class="fas fa-ban"></i> Deactivate Job
        </button>
        <button class="btn btn-primary">
  ...
  <div class="modal" id="employerModal">
    <div class="modal-content">
        ...
        <div class="profile-section">
          ...
          <div class="profile-info">
            ...
            <p id="companyIndustry">
              Industry: <strong>Software Development</strong>
            </p>
            <p id="companyStatus">
              Status:
              <span class="status verified"><i class="fas fa-circle"></i> Verified</span>
            </p>
            <p id="verificationDate">
              Verified on: <strong>October 15, 2023</strong>
            </p>
      ...
      <div id="documentsTab" class="tab-content">
        <h3
          style="margin-bottom: 1.5rem; font-size: 1.1rem; font-weight: 600">
          Submitted Documents
        </h3>
        ...
        <table style="width: 100%">
          ...
          <tbody>
            <tr>
              ...
              <td>24</td>
              <td>
                <span class="status verified"><i class="fas fa-circle"></i> Active</span>
              </td>
            </tr>
            <tr>
              <td>Backend Engineer</td>
  ...
  <div class="modal" id="documentsModal">
    <div class="modal-content" style="max-width: 900px">
      ...
      <div style="text-align: center; margin: 2rem 0">
        <img
          src="https://via.placeholder.com/800x1000?text=Business+License"
          alt="Document"
          style="
              max-width: 100%;
              max-height: 60vh;
  ...
  <script>
    ...
    const jobs = {
      "frontend-dev": {
        ...
        status: "active",
        description: "We are looking for a skilled Frontend Developer to join our team. You will be responsible for building user interfaces and implementing interactive web applications using modern JavaScript frameworks.",
        requirements: [
      ...
      "marketing-manager": {
        ...
        status: "active",
        description: "We are seeking an experienced Marketing Manager to lead our marketing team and develop strategies to promote our green energy solutions.",
        requirements: [
          "5+ years in marketing roles",
      ...
      "backend-engineer": {
        ...
        status: "expired",
        description: "Join our engineering team to build scalable backend systems and APIs for our digital products.",
        requirements: [
    ...
    function openJobModal(jobId) {
      ...
      document.getElementById(
        "jobModalTitle"
      ).textContent = `${job.title} Details`;
      document.getElementById("jobTitle").textContent = job.title;
      document.getElementById(
        "jobCompany"
      ).innerHTML = `<strong>${job.company}</strong> • ${job.location}`;
      document.getElementById(
        "jobSalary"
      ).innerHTML = `<strong>${job.salary}</strong> • ${job.type}`;
      document.getElementById(
        "jobDates"
      ).innerHTML = `Posted: <strong>${job.postedDate}</strong> • Expires: <strong>${job.expiryDate}</strong>`;
      ...
      const appSummary = document.querySelector(".details-section > div");
      appSummary.innerHTML = `
                <h4 style="margin-bottom: 1rem;">Applications Summary</h4>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="background: var(--gray-light); padding: 1rem; border-radius: 0.5rem; text-align: center;">
                        <div style="font-size: 0.875rem; color: var(--gray);">Total Applicants</div>
                        <div style="font-size: 1.5rem; font-weight: 700;">${job.applicants.total}</div>
                    </div>
                    <div style="background: var(--gray-light); padding: 1rem; border-radius: 0.5rem; text-align: center;">
                        <div style="font-size: 0.875rem; color: var(--gray);">Pending Review</div>
                        <div style="font-size: 1.5rem; font-weight: 700;">${job.applicants.pending}</div>
                    </div>
                    <div style="background: var(--gray-light); padding: 1rem; border-radius: 0.5rem; text-align: center;">
                        <div style="font-size: 0.875rem; color: var(--gray);">Referred</div>
                        <div style="font-size: 1.5rem; font-weight: 700;">${job.applicants.referred}</div>
                    </div>
                </div>
            `;

      // Update company logo
      document.querySelector("#jobModal .company-logo").src = job.logo;

      // Update status
      const statusElement = document.querySelector("#jobModal .status");
    ...
    function openEmployerModal(employerId) {
      ...
      document.getElementById(
        "employerModalTitle"
      ).textContent = `${employer.name} Profile`;
      document.getElementById("companyName").textContent = employer.name;
      document.getElementById(
        "companyIndustry"
      ).innerHTML = `Industry: <strong>${employer.industry}</strong>`;
      ...
      statusElement.innerHTML = `Status: <span class="status ${
          employer.status
        }"><i class="fas fa-circle"></i> ${
          employer.status === "verified" ? "Verified" : "Pending"
        }</span>`;

      // Update revoke button visibility
      document.getElementById("revokeBtn").style.display =
        employer.status === "verified" ? "flex" : "none";
    ...
    function approveEmployer(employerId) {
      if (
        confirm(
          `Approve ${employers[employerId].name}? This will allow them to post jobs.`
        )
      ) {
        employers[employerId].status = "verified";
        showNotification(
          "success",
          `Successfully approved ${employers[employerId].name}`
        );
    ...
    function rejectEmployer(employerId) {
      ...
      if (reason) {
        ...
        showNotification(
          "error",
          `Rejected ${employers[employerId].name}. Reason: ${reason}`
        );
        // In a real app, you would update the UI and send to server
        closeModal();
        location.reload(); // Simulate UI update
    ...
    function revokeVerification(employerId) {
      if (
        confirm(
          `Revoke verification for ${employers[employerId].name}? This will prevent them from posting new jobs.`
        )
      ) {
        employers[employerId].status = "pending";
        showNotification(
          "warning",
          `Verification revoked for ${employers[employerId].name}`
        );
        // In a real app, you would update the UI and send to server
        closeModal();
        location.reload(); // Simulate UI update
    ...
    function deactivateJob(jobId) {
      if (
        confirm(
          `Deactivate this job listing? It will no longer be visible to applicants.`
        )
      ) {
        jobs[jobId].status = "expired";
        showNotification("warning", "Job listing deactivated");
        closeModal();
        location.reload();
      }
    }
    ...
    function renewJob(jobId) {
      // Add 30 days to current date for new expiry
      const newExpiry = new Date();
      newExpiry.setDate(newExpiry.getDate() + 30);
      const formattedDate = newExpiry.toISOString().split("T")[0];

      jobs[jobId].status = "active";
      jobs[jobId].expiryDate = formattedDate;
      showNotification("success", "Job listing renewed for 30 days");
      closeModal();
      location.reload();
    }
