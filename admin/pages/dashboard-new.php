                  ...
                  <tr>
                    ...
                    <td>
                      <span class="status-badge badge-review"
                        ><i class="fas fa-clock"></i> Review</span
                      >
                    </td>
                    <td>
                      <button
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <p>
                        <strong>Email:</strong>
                        <span id="applicant-email"
                          >jennifer.wilson@example.com</span
                        >
                      </p>
                      <p>
                        <strong>Phone:</strong>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-4">
                  <div class="card bg-light p-3">
                    ...
                    <p>
                      <strong>Status:</strong>
                      <span class="status-badge badge-verified" id="job-status"
                        >Active</span
                      >
                    </p>
                  </div>
    ...
    <script>
      ...
      const applicantData = {
        "APP-3050": {
          ...
          experience:
            "5 years of experience in software development with focus on web technologies",
        },
        "APP-3051": {
          name: "Robert Davis",
          title: "Data Analyst",
          ...
          experience:
            "4 years of experience in data analysis and visualization",
        },
        "APP-3052": {
          name: "Emily Clark",
      ...
      const jobData = {
        "J-2056": {
          ...
          status: "Active",
          description:
            "We are looking for a skilled Senior Software Engineer to join our development team. The ideal candidate will have experience in building high-performing, scalable, enterprise-grade applications. You will be part of a talented software team that works on mission-critical applications.",
          requirements: [
        ...
        "J-2057": {
          ...
          status: "Active",
          description:
            "We are seeking a Data Analyst to help turn data into information, information into insight, and insight into business decisions. The ideal candidate will conduct full lifecycle analysis to include requirements, activities, and design.",
          requirements: [
        ...
        "J-2058": {
          ...
          status: "Active",
          description:
            "We are looking for a Cloud Architect to join our team and work on implementing cloud architectures for our clients. The ideal candidate will have a strong understanding of cloud computing technology and infrastructure.",
          requirements: [
            "Bachelor's degree in Computer Science or related field",
