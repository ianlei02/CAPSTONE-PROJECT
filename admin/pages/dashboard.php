              ...
              <tr>
                ...
                <td>
                  <span class="status expired"
                    ><i class="fas fa-circle"></i> Expired</span
                  >
                </td>
                <td>
                  <button
              ...
              <tr>
                ...
                <td>
                  <span class="status pending"
                    ><i class="fas fa-circle"></i> Pending</span
                  >
                </td>
                <td>
                  <button
              ...
              <tr>
                ...
                <td>
                  <span class="status verified"
                    ><i class="fas fa-circle"></i> Referred</span
                  >
                </td>
                <td>
                  <button
        ...
        <div class="profile-section">
          ...
          <div class="profile-info">
            ...
            <p>
              Applied for:
              <strong>
                <td>Frontend Developer at Tech Solutions Inc.</td></strong
              >
            </p>
            ...
            <p>
              Status:
              <span class="status pending"
                ><i class="fas fa-circle"></i> Pending Review</span
              >
            </p>
          ...
          <div class="profile-section">
            ...
            <div class="profile-info">
              ...
              <p id="companyStatus">
                Status:
                <span class="status verified"
                  ><i class="fas fa-circle"></i> Verified</span
                >
              </p>
              ...
              <div class="details-section">
                <div class="detail-row">
                  ...
                  <span id="hrContact"
                    >Sarah Johnson (hr@techsolutions.com)</span
                  >
                </div>
                <div class="detail-row">
                  <span class="detail-label">Phone:</span>
                ...
                <div class="detail-row">
                  ...
                  <span id="companyAddress"
                    >123 Tech Park, New York, NY 10001</span
                  >
                </div>
                <div class="detail-row">
    ...
    <script>
      ...
      const jobs = {
        "frontend-dev": {
          ...
          status: "active",
          description:
            "We are looking for a skilled Frontend Developer to join our team. You will be responsible for building user interfaces and implementing interactive web applications using modern JavaScript frameworks.",
          requirements: [
        ...
        "marketing-manager": {
          ...
          status: "active",
          description:
            "We are seeking an experienced Marketing Manager to lead our marketing team and develop strategies to promote our green energy solutions.",
          requirements: [
        ...
        "backend-engineer": {
          ...
          status: "expired",
          description:
            "Join our engineering team to build scalable backend systems and APIs for our digital products.",
          requirements: [
