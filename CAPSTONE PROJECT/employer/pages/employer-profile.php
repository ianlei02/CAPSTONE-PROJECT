...
<body>
    <div class="profile-container">
        <div class="profile-header">
            ...
            <p id="companyIndustry">Industrial Machinery Manufacturing | Established 2005</p>
            ...
            <div class="company-logo-container" id="logoContainer">
                <img src="https://via.placeholder.com/120" alt="Company Logo" class="company-logo" id="companyLogo">
                <input type="file" id="uploadLogo" class="upload-logo" accept="image/*">
            </div>
        </div>
        ...
        <div class="profile-content">
            <div class="section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value" id="companySize">201-500 employees</div>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Address</span>
                        <div class="info-value" id="companyAddress">123 Industrial Park, Laguna Technopark, Biñan, Laguna</div>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Contact Number</span>
                        <div class="info-value" id="contactNumber">(049) 511-2233</div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value" id="companyWebsite">www.abcmfg.com</div>
                    </div>
                </div>
                <div class="save-cancel-btns" id="companyInfoBtns">
                    <button class="btn btn-primary" id="saveCompanyInfo">Save</button>
                    <button class="btn btn-outline" id="cancelCompanyInfo">Cancel</button>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value" id="contactPerson">Maria Dela Cruz</div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        <span class="info-label">Email</span>
                        <div class="info-value" id="contactEmail">maria.delacruz@abcmfg.com</div>
                    </div>
                </div>
                <div class="save-cancel-btns" id="contactBtns">
                    <button class="btn btn-primary" id="saveContactInfo">Save</button>
                    <button class="btn btn-outline" id="cancelContactInfo">Cancel</button>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <button class="btn btn-outline" style="margin-top: 10px;">+ Add Document</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('editCompanyInfoBtn').addEventListener('click', function() {
        ...
        document.getElementById('cancelCompanyInfo').addEventListener('click', function() {
            cancelEdit('company');
        });
        ...
        document.querySelectorAll('.view-doc').forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault();
                const docName = this.closest('.document-item').querySelector('.document-name').textContent;
        ...
        function toggleEditMode(section) {
            ...
            const fields = {
                'company': ['companyType', 'industry', 'companySize', 'companyAddress', 'contactNumber', 'companyEmail', 'companyWebsite'],
                'contact': ['contactPerson', 'contactPosition', 'contactMobile', 'contactEmail']
            };
